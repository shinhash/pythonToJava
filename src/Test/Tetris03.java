...
public class Tetris03 extends JFrame {
   ...
   private JLabel[][] lblArray2d = new JLabel[20][10];
   ...
   public Tetris03() {
      ...
      lblDisp.setFont(new Font("����", Font.PLAIN, 15));
      lblDisp.setBounds(283, 31, 57, 15);
      contentPane.add(lblDisp);
      
      lblRow = new JLabel("1");
      lblRow.setFont(new Font("����", Font.PLAIN, 15));
   ...
   public ArrayList<String> getNotFullStack() {
      ...
      for(int i=0; i<stack2D.length;i++) {
         ...
         if(               // 
            ...
            String str_line = tmp[0]+","+tmp[1]+","+tmp[2]+","+tmp[3]+","+tmp[4]+","+tmp[5]+","+tmp[6]+","+tmp[7]+","+tmp[8]+","+tmp[9]; // �� ä������ ���� ���
